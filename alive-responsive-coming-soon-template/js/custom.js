...
*/
$( function() {
        var endDate = "October 02,2022 15:03:25";
        ...
        $('.countdown.styled').countdown({
          ...
          render: function(data) {
            $(this.el).html("<div>" + this.leadingZeros(data.days, 3) + " <span>Dias</span></div><div>" + this.leadingZeros(data.hours, 3) + " <span>Horas</span></div><div>" + this.leadingZeros(data.min, 3) + " <span>Minutos</span></div><div>" + this.leadingZeros(data.sec, 3) + " <span>Segundos</span></div>");
          }
        });
