...
$( function() {
        ...
        $('.countdown.styled').countdown({
          ...
          render: function(data) {
            $(this.el).html("<div>" + this.leadingZeros(data.days, 3) + " <span>days</span></div><div>" + this.leadingZeros(data.hours, 4) + " <span>hrs</span></div><div>" + this.leadingZeros(data.min, 6) + " <span>min</span></div><div>" + this.leadingZeros(data.sec, 7) + " <span>sec</span></div>");
          }
        });
